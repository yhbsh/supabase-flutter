...
({String accessToken, String sessionString}) getSessionData(DateTime accessTokenExpireDateTime) {
  final accessTokenExpiresAt = accessTokenExpireDateTime.millisecondsSinceEpoch ~/ 1000;
  final accessTokenMid = base64.encode(utf8.encode(json.encode({'exp': accessTokenExpiresAt, 'sub': '1234567890', 'role': 'authenticated'})));
